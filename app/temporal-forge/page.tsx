  ...
  return <main className="temporal-shell min-h-screen text-white">
    <header className="site-header sticky top-0 z-20 border-b border-white/20 px-5 py-3 md:px-8">
      <div className="mx-auto flex max-w-[1600px] items-center justify-between gap-5">
        <div><p className="text-[10px] uppercase tracking-[0.26em]">FoldForge</p><p className="mt-1 font-mono text-[7px] uppercase tracking-[0.18em] text-white/35">Visual time instrument</p></div>
        <nav className="flex gap-5 text-[9px] uppercase tracking-[0.2em]"><Link className="text-white/40 hover:text-white" href="/">Archive</Link><Link className="text-white/40 hover:text-white" href="/sonic-forge">Sonic Forge</Link><span>Temporal Forge</span></nav>
      </div>
    </header>
