...
const LOCAL_PREPARED_MINTS = "/ledger-witness/prepared-mints.json";
...
export default function LedgerWitness() {
  ...
  return <main className="min-h-screen bg-black text-white">
    ...
    <div className="mx-auto max-w-[1600px] px-5 py-10 md:px-8 md:py-16">
      <section className="grid gap-10 border-b border-white/20 pb-12 lg:grid-cols-[1fr_0.75fr] lg:items-end"><div><p className="text-[9px] uppercase tracking-[0.25em] text-white/40">FoldPortrait issuance / evidence / signature / archive</p><h1 className="mt-5 text-5xl font-light tracking-[-0.055em] md:text-7xl">Ledger Witness</h1><p className="mt-7 max-w-2xl text-sm leading-7 text-white/55">FoldPortrait’s exclusive XRPL issuance channel. Prepare one sealed work, hand its exact mint transaction to the configured Xaman wallet, and return the verified ledger result to its Sovereign Standard archive record.</p></div><div className="border border-white/20 p-5 font-mono text-[8px] uppercase leading-5 tracking-[0.14em] text-white/35">FoldPortrait works only<br />Local source snapshots and drafts<br />XRPL mainnet / NFTokenMint<br />Human Xaman signature required</div></section>
