...
export default function SonicForge() {
  ...
  return (
    <main className="sonic-shell min-h-screen bg-black text-white">
      <PublicHeader active="sonic" subtitle="Audio displacement & mastering instrument" />
